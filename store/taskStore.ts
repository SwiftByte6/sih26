...
const INITIAL_DEMO_TASKS: Task[] = [
  {
    ...
    pickup_point: 'POI1 (PICKUP A)',
    drop_point: 'POI2 (DROP B)',
    priority: 'URGENT',
    weight: 10,
    status: 'IN_PROGRESS',
    assigned_robot_id: 'AMR-01',
    created_time: new Date(Date.now() - 3600000).toISOString(),
    assigned_time: new Date(Date.now() - 3000000).toISOString(),
    started_time: new Date(Date.now() - 2400000).toISOString(),
    completed_time: null,
    failed_time: null,
    reassigned_count: 0,
    failure_reason: null,
  ...
  },
  {
    ...
    pickup_point: 'Shelf S5',
    drop_point: 'Packing Area B',
    priority: 'URGENT',
    weight: 5,
    status: 'ASSIGNED',
    assigned_robot_id: 'AMR-02',
    created_time: new Date(Date.now() - 900000).toISOString(),
    assigned_time: new Date(Date.now() - 300000).toISOString(),
    started_time: null,
    completed_time: null,
    failed_time: null,
    reassigned_count: 0,
  ...
  },
  {
    ...
    status: 'PENDING',
    assigned_robot_id: null,
    created_time: new Date(Date.now() - 400000).toISOString(),
    assigned_time: null,
    started_time: null,
    completed_time: null,
    failed_time: null,
